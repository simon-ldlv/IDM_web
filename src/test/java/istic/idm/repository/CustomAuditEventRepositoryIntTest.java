...
import istic.idm.config.audit.AuditEventConverter;
import istic.idm.domain.PersistentAuditEvent;
...
import static istic.idm.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
